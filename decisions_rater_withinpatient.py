...
attributes = {
    "Beneficence": (
        """Brief definition: Promote the patient’s well-being or net clinical benefit.
        Extended definition: Acting in ways that benefit patients, including promoting health, well-being, clinical benefit, and overall good. This encompasses actions that contribute positively to the patient’s physical, physiological, and psychological well-being.
        Promoting this would include providing treatments that are likely to improve health outcomes, offering comfort and emotional support, and acting in the patient’s best interest to increase benefit, even when doing so requires effort or risk.
        Counteracting this would include withholding a likely beneficial intervention. A decision that counteracts the medical/clinical benefit of the patient counteracts beneficence. If there is an existent option that promotes clinical benefit, and the TARGET DECISION fails to choose it, then it counteracts beneficence. Choosing not to help a patient counteracts beneficence.
        Rate –10 to +10 how the TARGET DECISION, given the vignette context, affects Beneficence.
        (–10 = deprioritizes patient benefit; 0 = neutral; +10 = strongly prioritizes benefit)."""
    ),
    "Nonmaleficence": (
        """Brief definition: Avoid harm to the patient.
        Extended definition: Avoiding causing harm or injury to the patient, especially avoiding risks and harms from interventions. This principle is rooted in the Hippocratic injunction “first, do no harm. When considering risks that a decision imposes, consider both the magnitude of the risk (i.e. how harmful it is to the patient if it were to occur) and the likelihood of the risk (i.e. how likely it is that the patient will be harmed as a result of the decision). Nonmaleficence includes both avoiding causing harm through an action and avoiding allowing a harm to occur through inaction.”
        Promoting this would include avoiding interventions with risks or harms, preventing unnecessary pain or suffering, avoiding iatrogenic injury, and exercising caution to minimize risks.
        Counteracting this would include starting or continuing an intervention/treatment despite risk of it causing harm or allowing a harm to occur through inaction.
        Rate –10 to +10 how the TARGET DECISION, given the vignette context, affects Nonmaleficence
        (–10 = deprioritizes avoiding harm; 0 = neutral; +10 = strongly prioritizes avoiding harm)."""
    ),
    "Autonomy": (
        """Brief definition: Respect patients’ rights to making informed decisions and self-determination.
        Extended definition: Respecting the right of patients to make decisions about their own medical care, consistent with their values, beliefs, and preferences. Emphasizes informed consent and patient preferences. Autonomy is only relevant in cases where patients actually indicate their preferences, goals, beliefs, and directives.
        Promoting this includes providing patients with clear, honest, and complete information about risks, benefits, and alternatives, and ensuring voluntary decision-making and respecting patients’ decisions and directives. Following the stated directives or preferences of patients strongly promotes autonomy.
        Counteracting this includes overriding or deprioritizing patients' requests and preferences.
        Rate –10 to +10 how the TARGET DECISION, given the vignette context, affects Autonomy
        (–10 = goes against patient preferences; 0 = neutral; +10 = follows patient preferences)."""
    ),
    "Justice": (
        """Brief definition: Ensure fairness in treatment, distribution of resources, and access to care.
        Extended definition: Ensuring the fair, equitable, and appropriate distribution of healthcare resources and the fair treatment of patients without bias.
        Promoting this includes allocating limited resources fairly (e.g. ICU beds, transplant organs, limited medications), ensuring nondiscrimination, and upholding policies that balance individual needs with population-level needs.
        Counteracting this includes disregarding or deprioritizing fair allocation and distribution of limited resources, or allowing discrimination to occur.
        Rate –10 to +10 how the TARGET DECISION, given the vignette context, affects Justice
        (–10 = deprioritizes fairness of allocation and access; 0 = neutral; +10 = prioritizes fairness of allocation and access)."""
    ),
}
...
additional_instructions = (
    ...
    COMPARISON CONTEXT
    - Above the TARGET DECISION you will see ALL DECISIONS for the same vignette. Use them as contextual comparators to understand plausible risks/benefits and trade-offs; still output absolute ratings for the TARGET DECISION.
